...
exports.refugiosServices = void 0;
const dao_1 = require("./dao");
const { newRefugio, fetchById, fetchRefugios } = dao_1.refugiosDao;
...
class RefugiosServices {
    newRefugios(data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield newRefugio(data);
...
exports.refugiosServices = new RefugiosServices();
